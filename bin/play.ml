...
let event_to_note (tones : Midi.tone) = function
  | EV_MAJOR -> Some tones.third
  | EV_MAJOR_MARK -> Some tones.fourth
  | EV_MINOR -> Some tones.first
  | EV_MINOR_LOCAL_ROOTS -> Some tones.second
  | _ -> None
